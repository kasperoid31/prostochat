...
Это история о маленьком мире, который собрал один мальчик, боявшийся одиночества.

Здесь жили настоящие люди. Они смеялись, ссорились, влюблялись, плакали в клавиатуру по ночам, женились на ботах, выращивали огурцы, теряли друг друга и возвращались снова.

**В этой книге нет вымысла.** Только реальные слова реальных людей. Слово в слово.

</td>
<td width="30%" align="center">

<img src="https://img.shields.io/badge/Жанр-документалистика-8B0000?style=for-the-badge&logo=bookstack&logoColor=white">
<img src="https://img.shields.io/badge/Страниц-~120-2E8B57?style=for-the-badge&logo=read-the-docs&logoColor=white">
<img src="https://img.shields.io/badge/Язык-русский-1E90FF?style=for-the-badge&logo=googletranslate&logoColor=white">
...
<details>
<summary><b>Кликни, чтобы увидеть всех</b></summary>
<br>

| Имя | Роль | Особенность |
|-----|------|-------------|
| **Саша (Каспер)** | Создатель чата | Носил имя своего умершего кота |
| **Лея (Амелия)** | Админ | Главная яойщица чата, ей было 10 лет |
| **Коля (Никола Тесла)** | Админ | Самый строгий, давал муты на 100 лет |
| **Акулист** | Житель чата | Бесконечное «ыыыы», страна Шишколенд |
| **Ника (Вероника)** | Админ | Три кошки, лучшая подруга |
| **Арчик (Арина)** | Житель чата | Ей было 11, писала в мужском роде |
| **Прося (Прасковья)** | Житель чата | «Меня зовут Прося. Всем похуй.» |
| **Женя** | Житель чата | Та самая страшная ночь |
| **Артём (Wexit)** | Житель чата | «Человек из чата. Мы все его любим.» |
| **Энтоти** | Житель чата | Вёл чатовую газету |
| **Всеволод (Сева)** | Житель чата | «СЕВА КРАШ МИРА», кот в сметане |
| **Амина (SwiftKey)** | Админ | Главная креветка и клавиатура чата |
| **Кибитка** | Первый житель | Кидал живые обои. Его больше нет. |
| **саша йотвекс** | Житель чата | Её больше нет. |
| **саша хлебушек** | Житель чата | Её больше нет. |
...
**Эта книга никогда не будет дописана до конца.**

«просточат» — это живая история. Каждый день в ней могут появляться новые страницы, новые детали, новые имена.

Кто-то вдруг вспомнит забытую шутку. Кто-то найдёт старый скриншот. Кто-то захочет рассказать свою версию событий.
...
### 📝 Дополнить
Расскажи то, чего в книге нет.  
Вспомни имена, которые пропустили.

</td>
<td align="center" width="33%">

### 🖼️ Поделиться
Скриншоты, логи, старые переписки  
— всё, что сохранилось.
...
### 🔧 Исправить
Если я ошибся в имени, дате или факте  
— скажи, я всё поправлю.
...
| Вариант | Для кого |
|---------|----------|
| **Fork → Pull Request** | Для тех, кто умеет пользоваться GitHub |
